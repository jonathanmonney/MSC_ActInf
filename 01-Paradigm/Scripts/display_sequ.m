...
if (i == 4) || (i == 8) || (i == 12) || (i == 16) || (i == 20) || (i == 24)...
    ...
    output_file = strcat(participant, '_TASK1_', int2str(i), '_',...
